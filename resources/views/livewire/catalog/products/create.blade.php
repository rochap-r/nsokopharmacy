<div class="max-w-7xl mx-auto py-8 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 flex justify-end">
        <button type="submit"
            class="inline-flex items-center px-5 py-3 rounded-lg transition-colors duration-200
           bg-orange-200 text-gray-700 hover:bg-orange-300 hover:text-gray-900
           dark:bg-orange-800 dark:text-gray-300 dark:hover:bg-orange-700 dark:hover:text-gray-100
           focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
            ...
            <span wire:loading wire:target="create" class="inline-flex items-center">
