<div class="max-w-7xl mx-auto py-8 sm:px-6 lg:px-8">
    <header class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ tenant_route('tenant.catalog.index') }}" wire:navigate
            class="inline-flex items-center text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100 transition-colors duration-200">
    ...
    <div
        class="bg-white rounded-xl shadow-md p-8 dark:bg-gray-800/90 dark:backdrop-blur-sm dark:border dark:border-gray-700 transition-all duration-200 hover:shadow-lg">
        ...
        <form wire:submit.prevent="update" class="space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="space-y-2">
                    <label for="dci"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-200 flex items-center">
                        DCI <span class="text-red-500 ml-1">*</span>
                    </label>
                    <div class="group relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none z-10">
                            <svg class="h-5 w-5 text-gray-400 group-focus-within:text-primary-500 transition-colors duration-200 dark:text-gray-500"
                    ...
                    <div class="group relative">
                        ...
                        <select wire:model="personne" id="personne"
                            ...
                            @foreach (\App\Enums\PersonType::cases() as $enum)
                                <option value="{{ $enum->value }}"
                                    {{ isset($product) && isset($product->personne) && $product->personne->value === $enum->value ? 'selected' : '' }}>
                                    {{ $enum->label() }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="group relative">
                        ...
                        <select wire:model="aisle_id" id="aisle_id"
                            ...
                            @foreach ($aisles as $aisle)
                                <option value="{{ $aisle['id'] }}">{{ $aisle['name'] }} ({{ $aisle['code'] }})
                                    {{ $aisle['is_global'] ? '- Global' : '' }}</option>
                            @endforeach
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="bg-gray-50 dark:bg-gray-800/70 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-5 flex items-center">
                    <svg class="h-5 w-5 mr-2 text-primary-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z"
                            clip-rule="evenodd" />
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0 flex h-6 items-center">
                            <input wire:model="active" id="active" type="checkbox" {{ $active ? 'checked' : '' }}
                        ...
                        <div class="text-sm leading-6">
                            <label for="active" class="font-medium text-gray-900 dark:text-gray-100">Actif</label>
                            <p class="text-gray-500 dark:text-gray-400 mt-1">Cochez cette case si le produit est actif
                                et disponible à la vente.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="text-sm leading-6">
                            <label for="featured" class="font-medium text-gray-900 dark:text-gray-100">Mis en
                                avant</label>
                            <p class="text-gray-500 dark:text-gray-400 mt-1">Cochez cette case pour mettre ce produit
                                en avant sur la page d'accueil.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex justify-end gap-3">
                <a href="{{ tenant_route('tenant.catalog.index') }}"
                    class="px-5 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800/70 transition-colors duration-200 inline-flex items-center font-medium"
                    wire:navigate>
                ...
                <button type="submit"
                    class="px-5 py-2.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 font-medium transition-all duration-200 inline-flex items-center">
